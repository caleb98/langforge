...
public class PhonologicalRuleApplicatorTest {
	...
	private void testRuleApplications(String patternSource, String ruleSource, boolean lenient, Map<String, String> expectations) {
		try {
