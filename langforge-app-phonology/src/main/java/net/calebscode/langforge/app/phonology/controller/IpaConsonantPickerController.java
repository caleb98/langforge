...
public class IpaConsonantPickerController extends AnchorPane implements FXMLController {
	...
	public IpaConsonantPickerController(PhonologicalInventoryModel model) {
		load(() -> {
