...
public class SyllablePatternCategoryModel extends SyllablePatternCategoryMap {

	private MapProperty<Character, Set<Phoneme>> categoryMap;
	private ReadOnlyMapWrapper<Character, Set<Phoneme>> categoryWrapper;

	public SyllablePatternCategoryModel() {
